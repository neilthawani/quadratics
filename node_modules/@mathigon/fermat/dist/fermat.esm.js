import { unique, total, toLinkedList, tabulate, isOneOf, flatten, repeat2D, tabulate2D, uid, repeat, list } from '@mathigon/core';
...
export { Angle, Arc, Bounds, Circle, Complex, Fraction, Line, matrix as Matrix, Point, Polygon, Polyline, random as Random, Ray, Rectangle, regression as Regression, Sector, Segment, Triangle, Vector, binomial, clamp, correlation, covariance, cube, digits, eulerPhi, factorial, gcd, generatePrime, goldbach, intersections, isAngle, isArc, isBetween, isCircle, isInteger, isLineLike, isPoint, isPolygonLike, isPrime, isSector, lcm, lerp, listPrimes, log, mean, median, mod, mode, nearlyEquals, numberFormat, parseNumber, permutations, primeFactorisation, primeFactors, quadratic, round, roundTo, sign, square, stdDev, subsets, toFraction, toOrdinal, toWord, variance };
